...
export const ContainerScroll = ({
  ...
  // Add spring for extra smoothness
  const smoothRotate = useSpring(rotate, { stiffness: 28, damping: 18, mass: 1.2 });
...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      transition={{
        rotateX: { type: "spring", stiffness: 28, damping: 18, mass: 1.2 },
